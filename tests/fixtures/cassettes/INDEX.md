...
| **Copilot Studio minimalBots PPAPI** (`/copilotstudio/minimalBots/api/{cdsBotId}/components`, `/copilotstudio/minimalBots/alm/{cdsBotId}/configure`, `/copilotstudio/minimalBots/alm/{cdsBotId}/export`) | `documented` | Internal OpenAPI contract at `C:\Users\dawnjeong\knowledge\ess-da-migration\documents\swagger.json` + auth handoff at `C:\Users\dawnjeong\knowledge\ess-da-migration\documents\AgentBuilder-Test-Agent-API-Auth-Handoff-2026-09-01.md`. | Per-environment PPAPI host, distinct from global `api.powerplatform.com`. No live cassette captured yet. Unit tests may assert URL construction, params, headers, binary export, and documented-schema response parsing only. |
