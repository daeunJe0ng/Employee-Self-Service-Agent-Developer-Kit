...
class AzureArmClient:
    ...
    def get_subscription(self, subscription_id: str) -> dict:
        ...
        ``insufficient_permissions`` on 401/403 (health unverifiable) and
        ``not_found`` on 404 (the bound subscription was deleted or is not
        visible to this sign-in). Returning sentinels instead of raising lets
        the caller surface a targeted message rather than a generic error.
        """
